        ...
        <div class="cookie-box__content">
          ...
          <div>
            ...
            <div class="cookie-box__desc">
              ${languages[settings.language].content}
              <a href="${settings.url}" target="_blank">${languages[settings.language].learnMore} &raquo;</a>
            </div>
            </div> 
          </div>
        <div class="cookie-box__buttons">
          <button class="cookie-box__button">
          <span>${languages[settings.language].accept}</span>
